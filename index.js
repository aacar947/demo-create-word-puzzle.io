...
generateBtn.addEventListener('click', () => {
  const _puzzle = createWordPuzzle({
  ...
  App(_puzzle);
  cleanObjectViwer()
  genarateNestedObjectElement(_puzzle, document.getElementById('object-viewer').querySelector('ul'));
});
...
function cleanObjectViwer() {
  document.getElementById('object-viewer').querySelector('ul').innerHTML = '';
}

cleanObjectViwer()
genarateNestedObjectElement(puzzle, document.getElementById('object-viewer').querySelector('ul'));
